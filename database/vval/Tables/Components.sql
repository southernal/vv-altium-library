...
GO
CREATE NONCLUSTERED INDEX [IX_ComponentType] ON [dbo].[Components]([ComponentType] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_ComponentSubType] ON [dbo].[Components]([ComponentSubType] ASC);
