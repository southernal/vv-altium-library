...
AS
     SELECT PartId,
            ...
            ComponentLink3URL,
            TemperatureRange AS [Junction Operating Temperature],
            ...
            CurrentReverseLeakage AS [Current Reverse Leakage @ Vr],
            ReverseRecoveryTime AS [Reverse Recovery Time (trr)],
            VoltageDcReverse AS [Voltage DC Reverse (Vr)],
            CurrentRectified AS [Current Rectified],
            VoltageForward AS [Voltage Forward (Vf)]
     FROM dbo.Components
     WHERE(ComponentType = 'DIO')
          AND (ComponentSubType = 'RECT');
