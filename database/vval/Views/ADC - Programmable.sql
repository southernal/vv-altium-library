...
AS
     SELECT TOP (100) PERCENT PartId,
                              ...
                              Series,
                              NumberOfBits AS [Number of Bits],
                              SamplingRate AS [Samping Rate],
                              NumberOfInputs AS [Number of Inputs],
                              InputType AS [Input Type],
                              DataInterface AS [Data Interface],
                              Configuration,
                              RatioSHADC AS [Ratio - S/H:ADC],
                              NumberADConverters AS [Number of A/D Converters],
                              Architecture,
                              ReferenceType AS [Reference Type],
                              Voltage AS [Voltage - Supply, Analog],
                              VoltageInput AS [Voltage - Supply, Digital],
                              Features
     FROM dbo.Components
     WHERE(ComponentType = 'ADC')
          AND (ComponentSubType = 'PROG');
