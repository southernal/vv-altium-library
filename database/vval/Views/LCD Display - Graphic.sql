...
AS
     SELECT TOP (100) PERCENT PartId,
                              ...
                              DisplayType AS [Display Type],
                              DisplayMode AS [Display Mode],
                              Touchscreen,
                              ViewingArea AS [Viewing Area],
                              Backlight,
                              DiagonalScreenSize AS [Diagonal Screen Size],
                              DotPixels AS [Dot Pixels],
                              GraphicsColour AS [Graphics Colour],
                              BackgroundColour AS [Background Colour],
                              DotSize AS [Dot Size],
                              DotPitch AS [Dot Pitch],
                              DataInterface AS [Data Interface]
     FROM dbo.Components
     WHERE(ComponentType = 'LCD')
          AND (ComponentSubType = 'GRAPHIC');
