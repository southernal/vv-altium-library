...
AS
     SELECT TOP (100) PERCENT PartId,
                              ...
                              FrequencyLower AS [Frequency - Lower],
                              FrequencyUpper AS [Frequency - Upper],
                              IsolationAtFrequency AS [Isolation @ Frequency],
                              Circuit,
                              InsertionLossAtFrequency AS [Insertion Loss @ Frequency],
                              P1dB,
                              Topology,
                              IIP3,
                              ...
                              Impedance
     FROM dbo.Components
     WHERE(ComponentType = 'RFIC')
          AND (ComponentSubType = 'SW');
